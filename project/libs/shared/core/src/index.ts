...
export { PostTypeEnum } from './lib/types/posts/post-type.enum';
export { PostStateEnum } from './lib/types/posts/post-state.enum';
...
export { PostFieldsRelation } from './lib/types/posts/post-fields.relation.interface';
